...
class OpenvasConnector:
    ...
    def create_credential(self, name, credential_type, comment=None, allow_insecure=None, certificate=None, key_phrase=None, 
                private_key=None, login=None, password=None,auth_algorithm=None, community=None, privacy_algorithm=None, privacy_password=None, public_key=None):
       
        with self.gmp as gmp:
            self.__authenticate__(gmp)
            return etree.tostring(gmp.create_credential(name, credential_type, comment=comment, allow_insecure=allow_insecure, certificate=certificate,
                key_phrase=key_phrase, private_key=private_key, login=login, password=password, auth_algorithm=auth_algorithm, community=community,
                privacy_algorithm=privacy_algorithm, privacy_password=privacy_password, public_key=public_key))
    ...
    def create_username_password_credential(self, name, login, password, comment=None, allow_insecure=None):
        ...
        return self.create_credential(self, name, credential_type, comment=comment, allow_insecure=allow_insecure, login=login, password=password)
